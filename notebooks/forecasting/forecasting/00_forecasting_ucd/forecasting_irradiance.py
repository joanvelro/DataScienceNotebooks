...
ts = df0['Global Horizontal [W/m^2]']
...
ax.plot(y,'k-')
plt.ylabel('Solar Irradiance $G_t$ $(W/m^2)$', fontsize=18)
plt.xlabel('Time t', fontsize=18)
plt.legend(('$G_{t}$ $(W/m^2)$',), fontsize=16)
plt.savefig('fig_1_irradiance_data.eps')
plt.show()
plt.close()
...
plt.savefig('fig_2_irradiance_arima_model.eps')
plt.show()
plt.close()
...
plt.savefig('fig_3_irradiance_training.eps')
plt.show()
plt.close()
...
plt.legend(('Observed','Forecast'),fontsize=18)
plt.savefig('fig_4_irradiance_training_dynamic.eps')
plt.show()
plt.close()
...
ax.set_xlabel('Time t', fontsize=18)
plt.legend(('Observed','Forecast'),fontsize=18)
plt.savefig('fig_5_irradiance_forecast.eps')
plt.show()
plt.close()
...
df_irradiance_results.to_csv("results_forecast_irradiance.csv")
